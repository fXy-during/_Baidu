		...
		addhtml:function(obj,pageinit){
			return (function(){
				...
				if (end < pageinit.pageNum) {
					obj.append('<span>...</span>');
					obj.append('<a href="javascript:void(0);" class="zxfPagenum">'+(pageinit.pageNum-1)+'</a>');
					obj.append('<a href="javascript:void(0);" class="zxfPagenum">'+pageinit.pageNum+'</a>');
				}
				/*下一页*/
				...
				obj.append('<span class="margin-left">'+'到第'+'<input type="text" class="zxfinput" value="'+pageinit.current+'"/>'+'页'+'</span>');
